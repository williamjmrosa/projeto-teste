...
@PageUrl("http://localhost:8080/funcionarios/listar")
public class PaginaEditarFuncionario extends FluentPage{

	@FindBy(css = "a.btn.btn-info.btn-sm")
	private FluentWebElement botãoEditar;

	public FluentWebElement getBotãoEditar() {
		return botãoEditar;
	}

	public void setBotãoEditar(FluentWebElement botãoEditar) {
		this.botãoEditar = botãoEditar;
	}
